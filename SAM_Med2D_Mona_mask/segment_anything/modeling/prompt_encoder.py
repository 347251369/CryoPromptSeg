...
from .mamba_feature import VSSM
...
class PromptEncoder(nn.Module):
    def __init__(
        ...
        # 首先生成一组可学习的向量point embedding，大小为：4x1x256
        ...
        # 新加
        # 如果是之前的256通道就是mask_adapter
        # self.mask_adapter = VSSM()
        # 通道是96
        # self.mask_adapter1 = VSSM()
    ...
    def _embed_points(
        ...
        # 如果传入的prompt里面没有bbox，则补充一个【0，0】点到每个point后面，其对应的label为-1
        if pad:
    ...
    def forward(
        ...
        if masks is not None:
            ...
            # dense_embeddings = self.mask_adapter1(masks)
        else:
